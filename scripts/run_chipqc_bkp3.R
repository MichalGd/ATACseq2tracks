...
if (n_no_bam > 0) message("WARN: dropped ", n_no_bam, " sample(s) with missing BAM files")

has_peaks  <- !is.na(chipqc_ss$Peaks) & file.exists(chipqc_ss$Peaks) & (file.info(chipqc_ss$Peaks)$size > 0)
